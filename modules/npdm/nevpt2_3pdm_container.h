...
#ifndef NEVPT2_3PDM_CONTAINER_H
#define NEVPT2_3PDM_CONTAINER_H
...
class Nevpt2_3pdm_container : public Npdm_container {

  public:
    Nevpt2_3pdm_container( array_6d<double>& a16_matrix ) : a16_matrix_(a16_matrix) {};
    ~Nevpt2_3pdm_container() {};
