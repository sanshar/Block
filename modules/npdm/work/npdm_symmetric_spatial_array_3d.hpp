#ifndef __NPDM_SYMMETRIC_SPATIAL_ARRAY_3D_HPP
#define __NPDM_SYMMETRIC_SPATIAL_ARRAY_3D_HPP
...
// DEBUG
      std::cout << "V_offset_ijk_lmn_ = " << V_offset_ijk_lmn_ << std::endl;
      std::cout << "V_offset_ijk_ijk_ = " << V_offset_ijk_ijk_ << std::endl;
      std::cout << "V_offset_ijk_lmm_ = " << V_offset_ijk_lmm_ << std::endl;
      std::cout << "V_offset_ijk_llm_ = " << V_offset_ijk_llm_ << std::endl;
      std::cout << "V_offset_ijk_lll_ = " << V_offset_ijk_lll_ << std::endl;
      std::cout << "V_offset_ijj_lmm_ = " << V_offset_ijj_lmm_ << std::endl;
      std::cout << "V_offset_ijj_llm_ = " << V_offset_ijj_llm_ << std::endl;
      std::cout << "V_offset_ijj_iij_ = " << V_offset_ijj_iij_ << std::endl;
      std::cout << "V_offset_ijj_lll_ = " << V_offset_ijj_lll_ << std::endl;
      std::cout << "V_offset_iij_lmm_ = " << V_offset_iij_lmm_ << std::endl;
      std::cout << "V_offset_iij_llm_ = " << V_offset_iij_llm_ << std::endl;
      std::cout << "V_offset_iij_lll_ = " << V_offset_iij_lll_ << std::endl;
      std::cout << "V_offset_iii_lll_ = " << V_offset_iii_lll_ << std::endl;
   }
...
private:
   ...
   size_t __SF_get_ordinal (int i, int j, int k, int l, int m, int n) const
   {
      ...
      // check {l,m,n}
      __SC_index_info_3pdm lmn(n,m,l);
...
V_offset_check(V_offset_ijk_ijk_,V_offset_ijk_lmm_,iaddr);
            }
            else
            {
...
V_offset_check(V_offset_ijk_lmn_,V_offset_ijk_ijk_,iaddr);
            }
            break;
         case T3_IJKLMM:
            // size: 3*N3*N2
...
V_offset_check(V_offset_ijk_lmm_,V_offset_ijk_llm_,iaddr);
            break;
         case T3_IJKLLM:
            // size: 3*N3*N2
...
V_offset_check(V_offset_ijk_llm_,V_offset_ijk_lll_,iaddr);
            break;
         case T3_IJKLLL:
            // size: N3*N1
            iaddr = V_offset_ijk_lll_
                  + ijkOrd*extent_+lmnOrd;
V_offset_check(V_offset_ijk_lll_,V_offset_ijj_lmm_,iaddr);
            break;
         case T3_IJJLMM:
            // size: 2*N2*(N2+1)/2
...
V_offset_check(V_offset_ijj_lmm_,V_offset_ijj_llm_,iaddr);
            break;
         case T3_IJJLLM:
            if(ijkOrd == lmnOrd)
            {
...
V_offset_check(V_offset_ijj_iij_,V_offset_ijj_lll_,iaddr);
            }
            else
            {
               // size: 2*N2*(N2-1)/2
...
V_offset_check(V_offset_ijj_llm_,V_offset_ijj_iij_,iaddr);
            }
            break;
         case T3_IJJLLL:
            // size: N2*N1
            iaddr = V_offset_ijj_lll_
                  + ijkOrd*extent_+lmnOrd;
V_offset_check(V_offset_ijj_lll_,V_offset_iij_lmm_,iaddr);
            break;
         case T3_IIJLMM:
            if(ijkOrd == lmnOrd)
            {
...
V_offset_check(V_offset_ijj_iij_,V_offset_iij_lmm_,iaddr);
            }
            else
            {
               // size: 2*N2*(N2-1)/2
...
V_offset_check(V_offset_iij_lmm_,V_offset_iij_llm_,iaddr);
            }
            break;
         case T3_IIJLLM:
            // size: 2*N2*(N2+1)/2
...
V_offset_check(V_offset_iij_llm_,V_offset_iij_lll_,iaddr);
            break;
         case T3_IIJLLL:
            // size: N2*N1
            iaddr = V_offset_iij_lll_
                  + ijkOrd*extent_+lmnOrd;
V_offset_check(V_offset_iij_lll_,V_offset_iii_lll_,iaddr);
            break;
         case T3_IIILLL:
            // size: N1*(N1+1)/2
            iaddr = V_offset_iii_lll_
                  + ijkOrd*(ijkOrd+1)/2+lmnOrd;
V_offset_check(V_offset_iii_lll_,store_.size(),iaddr);
      }

//std::cout << "(" << i << "," << j << "," << k << "," << l << "," << m << "," << n << ") :: address = " << iaddr << std::endl;
      return iaddr;
   }

// DEBUG
   void V_offset_check(int lo,int up,int id) const {
      if(id < lo || id >= up) std::cout << "Found bug :: address = " << id << " is out of [" << lo << "," << up << ")" << std::endl;
   }
...
#endif // __NPDM_SYMMETRIC_SPATIAL_ARRAY_3D_HPP
