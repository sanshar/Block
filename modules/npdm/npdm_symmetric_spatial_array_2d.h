#ifndef __NPDM_SYMMETRIC_SPATIAL_ARRAY_2D_H
#define __NPDM_SYMMETRIC_SPATIAL_ARRAY_2D_H
...
private:
   ...
   size_t __SF_get_ordinal (int i, int j, int k, int l) const
   {
      ...
      // check {l,m,n}
      __SC_index_info_2pdm kl(l,k); // (i,l),(j,k)
...
#endif // __NPDM_SYMMETRIC_SPATIAL_ARRAY_2D_H
