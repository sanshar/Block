...
//Renormalization functions for core and virtual operators                                                                                
void SparseMatrix::renormalise_transform_rpa
(const SparseMatrix& op_0,
 const std::vector<Matrix>& rotate_matrix_0,
      ...
      for (int QPrime = 0; QPrime < rotate_matrix_0.size (); ++QPrime) {
        if (rotate_matrix_0[QPrime].Ncols () != 0) {
          if (this->allowedQuantaMatrix (newQ, newQPrime)) {
            ...
            if (!doTrans) {
              MatrixRotate (rotate_matrix_0[Q], tmp_0(Q, QPrime), rotate_matrix_x[QPrime], this->operatorMatrix (newQ, newQPrime) );
              MatrixRotate (rotate_matrix_y[Q], tmp_0(Q, QPrime), rotate_matrix_0[QPrime], this->operatorMatrix (newQ, newQPrime) );
            }
            else {
              MatrixRotate (rotate_matrix_x[Q], tmp_0(Q, QPrime), rotate_matrix_0[QPrime], this->operatorMatrix (newQ, newQPrime) );
              MatrixRotate (rotate_matrix_0[Q], tmp_0(Q, QPrime), rotate_matrix_y[QPrime], this->operatorMatrix (newQ, newQPrime) );
            }
          }
          ++newQPrime;
        }
...
void SparseMatrix::build_and_renormalise_transform_rpa
(SpinBlock *big, const opTypes &ot_0, const opTypes &ot_i,
 const std::vector<Matrix>& rotate_matrix_0,
 const std::vector<Matrix>& rotate_matrix_x,
 const std::vector<Matrix>& rotate_matrix_y, bool doTrans,
      ...
      for (int QPrime = 0; QPrime < rotate_matrix_0.size (); ++QPrime) {
        if (rotate_matrix_0[QPrime].Ncols () != 0) {
          if (this->allowedQuantaMatrix (newQ, newQPrime)) {
            ...
            if (!doTrans) {
              MatrixRotate (rotate_matrix_0[Q], tmp_0->operatorMatrix(Q, QPrime), rotate_matrix_x[QPrime],
                            this->operatorMatrix (newQ, newQPrime) );
              MatrixRotate (rotate_matrix_y[Q], tmp_0->operatorMatrix(Q, QPrime), rotate_matrix_0[QPrime],
                            this->operatorMatrix (newQ, newQPrime) );
            }
            else {
              MatrixRotate (rotate_matrix_x[Q], tmp_0->operatorMatrix(Q, QPrime), rotate_matrix_0[QPrime],
                            this->operatorMatrix (newQ, newQPrime) );
              MatrixRotate (rotate_matrix_0[Q], tmp_0->operatorMatrix(Q, QPrime), rotate_matrix_y[QPrime],
                            this->operatorMatrix (newQ, newQPrime) );
            }
          }
          ++newQPrime;
