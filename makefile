...
SRC_npdm = modules/npdm/npdm.C modules/npdm/npdm_driver.cpp modules/npdm/npdm_patterns.cpp modules/npdm/npdm_operator_wrappers.cpp modules/npdm/npdm_expectations.cpp modules/npdm/npdm_operators.cpp modules/npdm/npdm_op_components.cpp modules/npdm/npdm_wrapper_selector.cpp modules/npdm/npdm_spin_adaptation.cpp modules/npdm/npdm_expectations_engine.cpp modules/twopdm/twopdm_driver.C modules/threepdm/threepdm_driver.C modules/fourpdm/fourpdm_driver.C modules/npdm/npdm_sparse_array.cpp
