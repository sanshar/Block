...
SRC_npdm = npdm.C modules/npdm/npdm_block_and_decimate.cpp modules/npdm/npdm_driver.cpp modules/npdm/npdm_patterns.cpp modules/npdm/npdm_operator_wrappers.cpp modules/npdm/npdm_expectations.cpp modules/npdm/npdm_operators.cpp modules/npdm/npdm_op_components.cpp modules/npdm/npdm_wrapper_selector.cpp modules/npdm/npdm_spin_adaptation.cpp modules/npdm/npdm_expectations_engine.cpp modules/npdm/npdm_sweep.cpp modules/threepdm/sweepthreepdm.C modules/threepdm/threepdm.C modules/fourpdm/sweepfourpdm.C modules/fourpdm/fourpdm.C 
