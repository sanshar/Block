...
SRC_npdm = modules/npdm/npdm.C modules/npdm/npdm_driver.cpp modules/npdm/npdm_patterns.cpp modules/npdm/npdm_expectations.cpp modules/npdm/npdm_wrapper_selector.cpp modules/npdm/npdm_spin_adaptation.cpp modules/npdm/npdm_expectations_engine.cpp modules/npdm/npdm_sparse_array.cpp modules/npdm/npdm_spin_ops.cpp modules/twopdm/twopdm_driver.C modules/twopdm/twopdm_operator_wrappers.cpp modules/threepdm/threepdm_driver.C modules/threepdm/threepdm_op_components.cpp modules/threepdm/threepdm_operators.cpp modules/threepdm/threepdm_operator_wrappers.cpp modules/fourpdm/fourpdm_driver.C modules/fourpdm/fourpdm_op_components.cpp modules/fourpdm/fourpdm_operators.cpp modules/fourpdm/fourpdm_operator_wrappers.cpp 
