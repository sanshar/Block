...
ifeq ($(USE_MKL), yes)
MKLLIB = /home/sheng/mkl/composer_xe_2013_sp1.0.080/mkl/lib/intel64
LAPACKBLAS = -L${MKLLIB} -lmkl_intel_lp64 -lmkl_sequential -lmkl_core
MKLFLAGS = /home/sheng/mkl/composer_xe_2013_sp1.0.080/mkl/include
...
SRC_transition= modules/transition_pdm/onepdm/transition_sweep.C modules/transition_pdm/onepdm/transition_onepdm.C modules/transition_pdm/twopdm/transition_sweep.C modules/transition_pdm/twopdm/transition_twopdm.C modules/transition_pdm/twopdm/transition_twopdm_2.C

SRC_spin_adapted =  modules/ResponseTheory/sweepCompress.C dmrg.C fiedler.C least_squares.C sweep_mps.C set_spinblock_components.C linear.C main.C readinput.C  save_load_block.C timer.C SpinQuantum.C Symmetry.C input.C Schedule.C orbstring.C slater.C csf.C StateInfo.C  Operators.C BaseOperator.C screen.C MatrixBLAS.C operatorfunctions.C opxop.C wavefunction.C solver.C davidson.C sweep_params.C sweep.C initblocks.C guess_wavefunction.C density.C rotationmat.C renormalise.C couplingCoeffs.C distribute.C new_anglib.C fci.C spinblock.C op_components.C IrrepSpace.C modules/generate_blocks/sweep.C modules/onepdm/sweep.C modules/onepdm/onepdm.C modules/twopdm/sweep.C modules/twopdm/twopdm.C modules/twopdm/twopdm_2.C $(SRC_genetic) SpinSpace.C include/IntegralMatrix.C $(SRC_transition) $(SRC_npdm) 
