...
(SpinBlock& startingBlock, const bool &forward, const int & forward_starting_size, const int &backward_starting_size,
 const int& restartSize, const bool &restart, const bool& warmUp, int nroots = 1);

void InitNewSystemBlock
(SpinBlock &system, SpinBlock &systemDot, SpinBlock &newSystem, const int &sys_add, const bool &direct,
 const Storagetype &storage= DISTRIBUTED_STORAGE, bool haveNormops = true, bool haveCompops = true, int nroots = 1);
