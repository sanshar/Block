...
%For benchmarking, some timing data per sweeps for the Cr$_2$ molecule (see Section~\ref{sec:cr2}), using 2.40GHz Intel Xeon Processor E5645 is provided in Table~\ref{tab:timing}.

%\begin{table}
%\caption{Wall clock time per sweep for the Cr$_2$ molecule with an active space of (24e, 30o), using 16 threads of 2.40GHz Intel Xeon Processor E5645. For these calculations the D$_{2h}$ point group symmetry was used.} \label{tab:timing}
% \begin{tabular}{lr}
%  \hline
%M& Wall time\\
%&(sec)\\
